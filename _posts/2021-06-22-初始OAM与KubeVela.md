...
但是对于业务开发来说，他们聚焦在业务逻辑、订单流转等功能实现上，如电商平台，订单系统、仓库系统、支付系统等。

他们不会太在意底层使用什么系统，你甚至用windows把他的tomcat服务跑起来就行。

因为稳定性是架构部门、或者系统部门或者是运维的事情。

然而如何说服业务开发部门来使用k8s系统呢？

你跟他讲一大堆k8s的好处，什么服务发现、什么负载均衡、什么自动伸缩，他其实并不关心，因为spring cloud有全家桶，什么都有，而且社区繁荣成熟。

大多业务部门，迫于公司领导对云原生要求，要求业务开发迁移至k8s平台。

但是k8s系统是一个极其复杂的系统，cluster、pod、deployment、statefulset、hpa、ingress、istio、service、镜像、docker等概念已经足以让人眼花缭乱，而且还涉及网络、存储等底层的技术。
